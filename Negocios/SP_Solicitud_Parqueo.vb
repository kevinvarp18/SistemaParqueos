...
Public Class SP_Solicitud_Parqueo
    '**********************************************************************
    ...
    Public parqueo_Acceso_a_Datos As SP_Solicitud_Acceso_a_Datos

    'Declaracion de constrcutor.
    Public Sub New(gstrconnString As String)
        Me.parqueo_Acceso_a_Datos = New SP_Solicitud_Acceso_a_Datos(gstrconnString)
    End Sub
End Class
