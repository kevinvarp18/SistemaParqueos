        ...
        <div class="container">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" Visible="true">
                <ContentTemplate>
                    ...
                    <asp:Label ID="lblNombreV" runat="server" Text=""></asp:Label><br>
                    <asp:Label ID="lblApellidoV" runat="server" Text=""></asp:Label><br>
                    <asp:Label ID="lblCorreoV" runat="server" Text=""></asp:Label><br>
                    <asp:Label ID="lblTelefonoV" runat="server" Text=""></asp:Label><br>
                    <asp:Label ID="lblUbicacionV" runat="server" Text=""></asp:Label>  <br>                 
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    </div>
