    ...
    Public Sub llenarTablaSolicitudes()
        ...
        For Each solicitudAct As Solicitud In solicitudes
            For rowCtr = 1 To rowCnt
                ...
                Dim hypLnkDatos As New HyperLink()

                filaTabla.ID = "filaTabla" + contador.ToString()
                hypLnkDatos.Text = solicitudAct.GstrFechaISG
                hypLnkDatos.Style("color") = "#0000ff"
                hypLnkDatos.Style("text-decoration") = "underline"
                Dim datosVisitantes As String = Me.solicitudNegocios.obtenerDatosUsuariosAtrasados(solicitudAct.GstrFechaISG)
                hypLnkDatos.NavigateUrl = "frm_DatosVisitantesAtrasados.aspx?id=" & datosVisitantes
                celdaNombre.Controls.Add(hypLnkDatos)
